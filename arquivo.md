...
```
LEIA idade
SE idade menor que 16 ENTÃO
    IMPRIMA "não pode votar"
SENÃO SE idade maior ou igual 16 E idade menor que 18 ENTÃO
    IMPRIMA "voto facultivo"
SENÃO
    IMPRIMA "voto obrigátorio"
FIM SE
```
______
...
ENQUANTO distanciaAtual MENOR QUE distanciaFinal E tempo MENOR QUE tempoMaximo E velocidadeAtual MENOR QUE velocidadeMaxima FAÇA
    tempo++
    velocidadeAual = velocidadeInicial + aceleracao * tempo
    SE velocidadeAtual MAIOR QUE velocidadeMaxima FAÇA
        velocidadeAtual = velocidadeMaxima
    FIM SE
    distanciaAtual = velocidadeInicial * tempo + 0.5 * aceleracao * tempo^2
FIM ENQUANTO
SE distanciaAtual >= distanciaFinal ENTAO:
    IMRPIMA "O carro completou a corrida em ", tempo, " minutos."
SENAO
    IMPRIMA "O carro completou a corrida fora do tempo máximo permitido."
FIM SE
FIM ALGORITMO
```
______
